...
전체 설계 배경은 [`docs/SPEC.md`](docs/SPEC.md)에, AI 코딩 규칙은 [`CLAUDE.md`](CLAUDE.md)에 있습니다. **Phase 0~10 전체가 완성**되었습니다 — 이 README는 지금 이 저장소를 어떻게 설치·실행하고, 각 기능을 어떻게 쓰는지를 다룹니다.
